...
const FurnaceGUIColorDef guiColors[GUI_COLOR_MAX]={
  ...
  D(GUI_COLOR_PIANO_ROLL_KEY_WHITE,"",ImVec4(0.85f,0.85f,0.85f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_KEY_BLACK,"",ImVec4(0.15f,0.15f,0.15f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_KEY_BORDER,"",ImVec4(0.40f,0.40f,0.40f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_GRID,"",ImVec4(0.30f,0.30f,0.30f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_GRID_HI1,"",ImVec4(0.55f,0.55f,0.55f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_GRID_HI2,"",ImVec4(0.45f,0.45f,0.45f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_NOTE,"",ImVec4(0.33f,0.65f,1.0f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_NOTE_OFF,"",ImVec4(0.80f,0.25f,0.25f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_NOTE_REL,"",ImVec4(0.80f,0.55f,0.20f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_SELECTION,"",ImVec4(1.0f,1.0f,1.0f,0.25f)),
  D(GUI_COLOR_PIANO_ROLL_FX_VOL,"",ImVec4(0.40f,0.80f,0.40f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_FX_NUM,"",ImVec4(0.70f,0.70f,0.20f,1.0f)),
  D(GUI_COLOR_PIANO_ROLL_FX_VAL,"",ImVec4(0.50f,0.50f,0.90f,1.0f)),
};
#undef D
